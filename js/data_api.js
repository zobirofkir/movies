...
const options = {
    ...
    headers: {
      ...
      Authorization: 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiIzYjM1OTAzZWNlMDM0MTc3MDEwMWQzNGM2NDdmMmFjOSIsInN1YiI6IjY1NjExODc3NDk3NTYwMDBjNjJmMjMwZiIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.cyE3__R6ibWn4TQnJhkHhSxa7LHzN5IRyPAsOYe7AUA'
    }
  };
  ...
  searchButton.addEventListener('submit', function(e){
    e.preventDefault();
    const urlSearch = `${url}/search/movie?query=${this.search.value}`;

    const searched = document.getElementById("apiSearch");
    fetch(urlSearch, options)
    .then(response => response.json())
    .then(json => {
        (json.results).map(result=>{
            const imageUrlCsw = result.poster_path
            ...
            <div class="">
                <div class="custom-block-icon-wrap">
                    <div class=""></div>
                    <a href="">
                        <img src="${imageUrlCsw}" class="custom-block-image img-fluid" alt="${result.title}">
                    </a>
                </div>
                <div class="mt-2">
            ...
            <div class="custom-block-info">
                ...
                <div class="profile-block d-flex">
                    ...
                    <p>
                        ...
                        <strong>${result.release_date}</strong>
                    </p>
                </div>
        
                <p class="mb-0">${result.overview}</p>
